...
function InstructionHardKS1() { // this function shows the instruction page before the game starts
    ...
    <div className="ks1-startpage">
      ...
      <div className="ks1-startCard">
        ...
        <div className="ks1-startMessage">
         <p>Drag or Drop and enter answer in your answer box </p> <h1>(In 60 seconds)</h1>
        </div>
      ...
      {showHowToPlay && (
        <div className="popupOverlay">
          <div className="popupBox ks2-howtoplay-popup">
            ...
            <h1>Step 2:</h1> <p>Calculate and enter answer in the box.</p>
...
export default InstructionHardKS1;