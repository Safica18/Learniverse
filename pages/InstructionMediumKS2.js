...
function InstructionMediumKS2() { // this function shows the instruction page before the game starts
       ...
       {showHowToPlay && (
        <div className="popupOverlay">
          <div className="popupBox ks2-howtoplay-popup">
            ...
            <h1>Step 2:</h1> <p>Look carefully at the array (row).</p>
            <h1>Step 3: </h1><p>Count the rows and columns.</p>
            <h1>Step 4:</h1> <p>Click the correct answer.</p>
...
export default InstructionMediumKS2;