...
function InstructionHardKS2() { // this function shows the instruction page before the game starts

  const navigate = useNavigate(); // navigate around pages
  const location = useLocation(); // gets information passed from previous page such as game title, number of questions etc.
       ...
       {showHowToPlay && (
        <div className="popupOverlay">
          <div className="popupBox ks2-howtoplay-popup">
            ...
            <h1>Step 2:</h1> <p>Use the picture to help you think.</p>
            <h1>Step 3:</h1> <p>Type your answer in the box.</p>
...
export default InstructionHardKS2;