...
import { useLocation, useNavigate } from "react-router-dom"; // useNavigate helps navigate users around pages, useLocation gets data sent from previous game pages
import "./Index.css"; // links CSS

function InstructionMediumKS1() { // this function shows the instruction page before the game starts

  const navigate = useNavigate(); // navigate around pages
  const location = useLocation(); // gets game information passed from Easy, Medium or Hard pages
    ...
    <div className="ks1-startpage">
      ...
      <div className="ks1-startCard">
        ...
        <div className="ks1-startMessage">
         <p>Click the correct basket</p> <h1>(In 30 seconds)</h1>
        </div>
      ...
      {showHowToPlay && (
        <div className="popupOverlay">
          <div className="popupBox ks1-howtoplay-popup">
            ...
            <h1>Step 2: </h1><p>Select the right basket</p>
            <h1>Step 3:</h1> <p>Click next, to move to the next question .</p>
...
export default InstructionMediumKS1;